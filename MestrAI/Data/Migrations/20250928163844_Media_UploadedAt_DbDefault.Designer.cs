...
namespace RPGSessionManager.Data.Migrations
{
    ...
    [Migration("20250928163844_Media_UploadedAt_DbDefault")]
    partial class Media_UploadedAt_DbDefault
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RPGSessionManager.Models.AiNpcStateChange", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("SessionId", "CharacterId", "ChangedAt")
                        .HasDatabaseName("IX_AiNpcStateChange_Session_Character_Date");

                    b.ToTable("AiNpcStateChanges");
                });
            ...
            modelBuilder.Entity("RPGSessionManager.Models.BattleMap", b =>
                {
                    ...
                    b.Property<string>("GridUnit")
                        .IsRequired()
                        .HasMaxLength(10)
                        .HasColumnType("TEXT");

                    b.Property<float>("GridUnitValue")
                        .HasColumnType("REAL");
            ...
            modelBuilder.Entity("RPGSessionManager.Models.NpcInteraction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("RPGSessionManager.Models.NpcLongTermMemory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("RPGSessionManager.Models.SessionAiCharacter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<int>("AiCharacterId")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<string>("PersonalitySettings")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("RPGSessionManager.Models.SessionAiCharacter", b =>
                {
                    b.HasOne("RPGSessionManager.Models.CharacterSheet", "AiCharacter")
                        .WithMany()
                        .HasForeignKey("AiCharacterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
